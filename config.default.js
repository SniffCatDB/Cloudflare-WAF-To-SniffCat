exports.MAIN = {
	...
	IP_REPORT_COOLDOWN: 8 * 60 * 60 * 1000, // Minimum time between reports of the same IP. Must be >= 20 minutes. Do not set too low values, as it would waste API quota due to daily rate limits.
