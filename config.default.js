exports.MAIN = {
	...
	CLOUDFLARE_TIME_RANGE: 12 * 60 * 60 * 1000, // Time range for fetching Cloudflare events in milliseconds (default: 23h 59min). Cloudflare limits time range to less than 86400s (24h) per query.
